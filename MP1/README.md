...
2. Create a simple program that will ask for a temperature in Fahrenheit as a console input and will output its equivalent value in Celsius. Provide screenshots of your source code using the 4 PLs you have chosen in #1. 

3. Write a simple program in your chosen PLs that can store and retrieve student information, such as the following: Name, Age, Year Level (1, 2, 3, 4), Course, GWA (float), and Grade Level (“Freshman”, “Sophomore”, “Junior”, “Senior”). 

**NOTE:** It is important that you first choose the languages you are going to want to use in making #2 and #3. If you think that the language you have chosen cannot implement the problem stated in #2 and #3, simply implement them up to what extent is the capability of your chosen language. Provide a quick explanation why your chosen language cannot implement such. 
